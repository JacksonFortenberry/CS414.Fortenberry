...
(** @canonical Stdune.Dune_filesystem_stubs *)
module Dune_filesystem_stubs = Stdune__Dune_filesystem_stubs
...
(** @canonical Stdune.Execution_env *)
module Execution_env = Stdune__Execution_env
...
(** @canonical Stdune.Flock *)
module Flock = Stdune__Flock
...
(** @canonical Stdune.Terminal_signals *)
module Terminal_signals = Stdune__Terminal_signals
